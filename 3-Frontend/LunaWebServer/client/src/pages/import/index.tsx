...
import ImportReceiptList from "@/components/import/ImportReceiptList";
        ...
        <div className="col-span-3">
          ...
          <div className="space-y-4">
            <div className="bg-white p-4 rounded-lg border">
              <div className="text-sm text-muted-foreground">Tổng giá trị đã nhập:</div>
              <div className="text-2xl font-bold">400M VND</div>
            </div>
            <div className="bg-white p-4 rounded-lg border">
              <div className="text-sm text-muted-foreground">Tổng số phiếu nhập:</div>
